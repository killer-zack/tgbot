...
എന്നെ നിർമ്മിച്ചിരിക്കുന്നത് python3 യിൽ python-telegram-bot ലൈബ്രറി ഉപയോഗിച്ചാണ്. ഞാൻ പൂർണ്ണമായിട്ടും ഓപ്പൺസോഴ്സ്ഡ് ആണ്. എന്റെ കോഡ് നിങ്ങൾക്ക് [ഇവിടെ](https://github.com/killer-zack/tgbot) കാണുവാൻ സാധിക്കും.
...
It took lots of work for [my creator](t.me/minimohanan) to get me to where I am now, and every donation helps \
            ...
            update.effective_message.reply_text(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup(
                    [[InlineKeyboardButton(text="🎉 Add me to your group", url="t.me/{}?startgroup=true".format(bot.username)),  InlineKeyboardButton(text="🤖 Make Own Admin Bot", url="https://youtu.be/W6CLKrehy6w")],
                     ...
                     [InlineKeyboardButton(text="🎬 Youtube Channel", url="https://youtube.com/channel/UC3iAQ4VIS59LiiJ3O_ki0sA"), InlineKeyboardButton(text="🛠 Help", url="https://t.me/{}?start=help".format(bot.username)) ]]))
